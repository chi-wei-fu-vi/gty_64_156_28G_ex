...
vsim -lib xil_defaultlib toplevel_tb_opt +UVM_TESTNAME=base_test +UVM_VERBOSITY=UVM_FULL -l base_test.log -wlf base_test.wlf -sv_seed 12345 +uvm_set_type_override=seq_mm_item,gty_prbs_seq
...
vsim -novopt -64 +acc=npr -L gtwizard_ultrascale_v1_7_3 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L tblib -L altlib +transport_int_delays +transport_path_delays +notimingchecks -t ps xil_defaultlib.glbl tblib.toplevel_tb +UVM_TESTNAME=base_test +UVM_VERBOSITY=UVM_FULL -l base_test.log -wlf base_test.wlf -sv_seed 12345 +uvm_set_type_override=seq_mm_item,gty_prbs_seq
